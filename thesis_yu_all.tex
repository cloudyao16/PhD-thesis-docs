...
\textcolor{red}{The increased BC core size after composition-averaging
  ...
  coating also contributed to the scattering underestimation.} The
...
\textcolor{red}{Coating volume shrink is not a good term. I had
  reworded it also in ch. 4. Can you check if the sentences in red
  above are correct?}

\textcolor{red}{Add sentence on SSA and if this is relevant for
  radiative forcing.}
...
\textcolor{red}{I removed the sentence about different particles
  having different sulfate formation rates-- you actually looked at
  this for quite some time after the prelim and we were never able to
  confirm this because the gas phase equalizes any differences... I do
  think one should revisit this, but I don't want to cause any
  questions here...}

\textcolor{red}{What do you think about the following paragraph:}
...
\textcolor{red}{BC-contained sounds strange. I changed it to
  BC-containing (also in earlier chapters). Can you do search and
  replace to make sure it's fixed everywhere?}
