...
clouds. This is the focus of this thesis.
...
number concentration \edits{and aerosol optical properties?} (3) What
...
\textcolor{red}{The next sentence still says Supporting
  Information!!!!}

The corresponding figure for the low-emission case is shown as
Figure~\ref{fig:sup1} in the Supporting Information. As expected, for
...
increased from $1.3\times10^{-4}$ to 10.9$\times
10^{-4}$~\unit{m^{-1}}.
...
\edits{We also found that cloud processing enhanced particle
...
errors introduced by simplified aerosol representation.  I first
